        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mt-6 flex flex-col sm:flex-row sm:justify-end gap-3">
                            ...
                            @if(auth()->user()->proyectos_usuarios->contains('proyecto_id', $proyecto['id']))
                            {{-- Si el usuario YA tiene este proyecto --}}
                            <a href="{{ route('proyecto_usuario.new') }}" class="tu-clase-css">
                                proyecto iniciado (ver proyecto)
                            </a>
                            @else
                            {{-- Si NO lo tiene --}}
                            <a href="{{ route('proyecto_usuario.new') }}" class="tu-clase-css">
